...
class MySceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=rma_mdp.STAIRS_ROAD_CFG,
        max_init_terrain_level=rma_mdp.STAIRS_ROAD_CFG.num_rows - 1,
        collision_group=-1,
...
class SpotObservationsCfg:
    ...
    adaptation_obs: AdaptationCfg = AdaptationCfg()
