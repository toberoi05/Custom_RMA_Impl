...
from rma_tasks.rma.modules import AdaptationModule
...
class BasePolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        default_sets = ["critic", "priv_obs", "adaptation_obs"] # Added priv_obs to take in environment state..WILL REMOVE ADAPTATION OBS LATER...AND ADD IT TO ADAPTATION MODULE RUNNER
